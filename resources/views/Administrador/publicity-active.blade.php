...
@section('content')
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <p class="text-center m-0 font-weight-bold" style="color: #267d24;font-size: 25px;">Publicidad activa</p>
        </div>
        <div class="card-body">
            <div class="row mb-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-center justify-content-xl-center align-items-xl-center col-pub-2">               
                                            <a class="btn btn-primary" role="button" href=" {{ route('admin.publicidad-activa-producto') }}">Administrar</a> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-3">
                                ...
                                <div class="card-body"> 
                                    <div class="row">
                                        ...
                                        <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-center justify-content-xl-center align-items-xl-center col-pub-2">
                                            <a class="btn btn-primary" role="button" href="{{ route('admin.publicidad-activa-servicio') }}">Administrar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-3">
                                ...
                                <div class="card-body"> 
                                    <div class="row">
                                        ...
                                        <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-center justify-content-xl-center align-items-xl-center col-pub-2">
                                            <a class="btn btn-primary" role="button" href="{{ route('admin.publicidad-activa-material') }}">Administrar</a> 
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow mb-3">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-center justify-content-xl-center align-items-xl-center col-pub-2">
                                            <a class="btn btn-primary" role="button" href="{{ route('admin.publicidad-activa-herramienta') }}">Administrar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
