...
@section('content')
    <div class="card shadow">
        ...
        <div class="card-body">
            <a class="btn btn-primary" role="button" style="margin-bottom: 20px;" href="create-classification-advisers.html">Agregar clasificación</a>
            <div class="row">
                <div class="col-md-6 text-nowrap">
                    <div id="dataTable_length" class="dataTables_length" aria-controls="dataTable" style="color: rgb(0,0,0);">
                        <label style="font-size: 18px;">Mostrar&nbsp;<select class="form-control form-control-sm custom-select custom-select-sm" style="width: 50%;color: rgb(0,0,0);">
                    ...
                    <tbody style="color: rgb(0,0,0);">
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger btn-entorno" role="button" href="#">Eliminar</a>
                            </td>
                        </tr>
                        <tr>
                            <td>456</td>
