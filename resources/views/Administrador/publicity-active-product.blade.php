...
@section('content')
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <p class="text-center m-0 font-weight-bold" style="color: #267d24;font-size: 25px;">Publicidad activa de productos</p>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="text-md-right d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-sm-start justify-content-md-end justify-content-lg-end justify-content-xl-end dataTables_filter" id="dataTable_filter">
                        <form class="d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex align-items-center align-items-sm-center align-items-md-center align-items-lg-center align-items-xl-center" id="buscadorActivaProductos">
                            <input class="form-control" type="text" placeholder="Buscar nombre" style="color: rgb(0,0,0);" id="buscarActivaProductos">
                    ...
                    <tbody style="color: rgb(0,0,0);">
                        @foreach($productos as $producto)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-danger btn-estado" role="button" href="{{ route('admin.publicidadActiva-remover-producto', ['id_pago' => $producto->id_pago]) }}">Eliminar</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
