...
@section('content')
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <p class="text-center m-0 font-weight-bold" style="color: #267d24;font-size: 25px;">Publicidad eliminada de servicios</p>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="text-md-right d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-sm-start justify-content-md-end justify-content-lg-end justify-content-xl-end dataTables_filter" id="dataTable_filter">
                        <form class="d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex align-items-center align-items-sm-center align-items-md-center align-items-lg-center align-items-xl-center" id="buscadorEliminadaServicios">
                            <input class="form-control" type="text" placeholder="Buscar nombre" style="color: rgb(0,0,0);" id="buscarEliminadaServicios">
                    ...
                    <tbody style="color: rgb(0,0,0);">
                        @foreach($servicios as $servicio)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary" role="button" href="{{ route('admin.publicidadRemovida-activar-servicio', ['id_pago' => $servicio->id_pago]) }}" style="margin-right: 10px;">Activar</a>
                                    <a class="btn btn-danger btn-estado" role="button" href="{{ route('admin.publicidadRemovida-eliminar-servicio', ['id_pago' => $servicio->id_pago]) }}">Eliminar</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
