...
@section('content')
    <div class="card shadow">
        ...
        <div class="card-body">
            <a class="btn btn-primary" role="button" style="margin-bottom: 20px;" href="create-material.html">Agregar material</a>
            <div class="row">
                    ...
                    <tbody style="color: rgb(0,0,0);">
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-danger btn-material" role="button" href="#">Eliminar</a>
                            </td>
                        </tr>
                        <tr>
                            <td>456</td>
