...
@section('content')
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <p class="text-center m-0 font-weight-bold" style="color: #267d24;font-size: 25px;">Publicidad pendiente de servicios</p>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="text-md-right d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-sm-start justify-content-md-end justify-content-lg-end justify-content-xl-end dataTables_filter" id="dataTable_filter">
                        <form class="d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex align-items-center align-items-sm-center align-items-md-center align-items-lg-center align-items-xl-center" id="buscadorPendienteServicios">
                            <input class="form-control" type="text" placeholder="Buscar" style="color: rgb(0,0,0);" id="buscarPendienteServicios">
                ...
                <table class="table dataTable my-0" id="dataTable">
                    <thead style="color: #267d24;">
                        <tr>
                            ...
                            <th style="font-size: 18px;">Imagen del servicio</th>
                        ...
                        @foreach($servicios as $servicio)
                            <tr>
                                ...
                                <td class="d-flex justify-content-start">
                                    <img src="{{ route('usuario.servicio-imagen', ['filename' => $servicio->imagen]) }}" style="width: 150px;">
                                </td>
                                <td>
                                    <a class="btn btn-primary" role="button" href="{{ route('admin.publicidad-activar-servicio', ['id_pago' => $servicio->id_pago]) }}" style="margin-right: 10px;">Activar</a>
                                    <a class="btn btn-danger btn-estado" role="button" href="{{ route('admin.publicidad-remover-servicio', ['id_pago' => $servicio->id_pago]) }}">Eliminar</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                    <tfoot style="color: #267d24;">
                        <tr>
                            ...
                            <td><strong>Imagen del servicio</strong></td>
                            <th style="font-size: 18px;">Acción</th>
                        </tr>
                    </tfoot>
                </table>
