                    ...
                    <div class="p-5">
                        <form class="user">
                            <div class="form-group row">
                                <input class="form-control form-control-user" type="text" placeholder="Nombre del producto" name="nombreProducto" style="font-size: 18px;color: rgb(0,0,0);max-width: 67%;">
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6 d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex align-items-center align-items-sm-center align-items-md-center align-items-lg-center align-items-xl-center mb-3 mb-sm-0">
                                    ...
                                    <input class="form-control form-control-user" type="number" style="font-size: 18px;color: rgb(0,0,0);max-width: 80%;" placeholder="Precio">
                                </div>
                            </div>
                            <div class="form-group row">
