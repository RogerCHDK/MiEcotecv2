                    ...
                    <div class="p-5">
                        <form class="user" action="{{route('productos.store')}}" method="POST" enctype="multipart/form-data">  
                            ...
                            <div class="form-group row"> 
                                <input class="form-control form-control-user @error('nombre') is-invalid @enderror" type="text" placeholder="Nombre del producto" name="nombre" id="nombre" style="font-size: 18px;color: rgb(0,0,0);max-width: 67%;">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input class="form-control form-control-user @error('telefono') is-invalid @enderror" type="tel" placeholder="Teléfono" style="font-size: 18px;color: rgb(0,0,0);" name="telefono" id="telefono">
                                    @error('telefono')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
