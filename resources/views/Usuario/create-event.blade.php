                        ...
                        <form class="user" action="{{route('evento.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0" style="min-width: 80%;">
                                    <input class="form-control form-control-user @error('nombre') is-invalid @enderror" type="text" placeholder="Nombre del evento" id="nombre" name="nombre" style="font-size: 18px;color: rgb(0,0,0);">
                                    @error('nombre')
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0" style="min-width: 90%;">
                                    <textarea class="form-control form-control-user @error('objetivo') is-invalid @enderror" placeholder="Objetivo" id="objetivo" name="objetivo" style="font-size: 18px;color: rgb(0,0,0);"></textarea>
                                    @error('objetivo')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0" style="min-width: 100%;">
                                    <textarea class="form-control form-control-user @error('descripcion') is-invalid @enderror" placeholder="Descripción" id="descripcion" name="descripcion" style="font-size: 18px;color: rgb(0,0,0);"></textarea>
                                    @error('descripcion')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="resume-content">
                                ...
                                <input class="form-control form-control-user @error('fecha_inicio') is-invalid @enderror" id="fecha_inicio" name="fecha_inicio" type="date" placeholder="Fecha"></input>
                                @error('fecha_inicio')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="resume-content">
                                ...
                                <input class="form-control form-control-user @error('hora_inicio') is-invalid @enderror" id="hora_inicio" name="hora_inicio" type="time" placeholder="Fecha"></input>
                                @error('hora_inicio')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="resume-content">
                                ...
                                <input class="form-control form-control-user @error('fecha_fin') is-invalid @enderror" id="fecha_fin" name="fecha_fin" type="date" placeholder="Fecha"></input>
                                @error('fecha_fin')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="resume-content">
                                ...
                                <input class="form-control form-control-user @error('hora_fin') is-invalid @enderror" id="hora_fin" name="hora_fin" type="time" placeholder="Fecha"></input>
                                @error('hora_fin')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
