                            ...
                            <div class="card shadow mb-3">
                                <div class="card-header py-3">
                                    <p class="text-center m-0 font-weight-bold" style="color: #267d24;font-size: 22px;">
                                        <a class="event_title" href="view-profile.html">Valerie Luna Luna</a>
                                    </p>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col d-flex flex-column colum-esp">
                                            ...
                                            <span class="text-justify" style="color: rgb(0,0,0);font-size: 18px;">Botánica</span>
                                        </div>
                                        <div class="col d-flex flex-column colum-esp">
                                            <span style="color: #267d24;font-size: 18px;margin-right: 3px;">Correo electrónico:</span>
                                            <span class="text-justify" style="color: rgb(0,0,0);font-size: 18px;">ejemplo@ejemplo.com</span>
                                        </div>
                                        <div class="col d-flex flex-column colum-tel">
                                            <span style="color: #267d24;font-size: 18px;margin-right: 3px;">Teléfono:</span>
                                            <span class="text-justify" style="color: rgb(0,0,0);font-size: 18px;">7221234567</span>
                                        </div>
                                        <div class="col d-flex flex-column" style="max-width: 100%;min-width: 100%;">
                                            ...
                                            <span class="text-justify" style="color: rgb(0,0,0);font-size: 18px;">Certificación Edomex, Certificación ITTol, Certificación UAEMex</span>
                                        </div>
                                        <div class="col d-flex flex-column" style="max-width: 100%;min-width: 100%;">
                                            <span style="color: #267d24;font-size: 18px;margin-right: 3px;">Sobre el asesor:</span>
                                            <span class="text-justify" style="color: rgb(0,0,0);font-size: 18px;">La botánica (del βοτάνη, 'hierba')(del griego φυτόν, 'planta' y λόγος, 'tratado') es la rama de la&nbsp;que estudia las plantas, bajo todos sus aspectos, lo cual incluye: descripción, clasificación, distribución, identificación, el estudio de su reproducción, fisiología, morfología, relaciones recíprocas, relaciones con los otros seres vivos y efectos provocados sobre el medio en el que se encuentran.
                                            </span>
                                        </div>
                                    </div>
                                </div>
