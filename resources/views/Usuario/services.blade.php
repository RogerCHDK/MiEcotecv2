...
@section('content')
                                ...
                                <div class="card border-0">
                                    <a href="service.html">
                                        <div class="marco zoom-on-hover">
                                            <img class="img-fluid image" src="assets/img/Servicios/lavanderia.jpg">
                                        </div>
                                    </a>
                                    <div class="card-body text-center">
                                        <h6>
                                            <a class="event_title" href="service.html" style="font-size: 22px;">Lavandería ecológica<br></a>
                                        </h6>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-4 col-asis">
                                <div class="card border-0">
                                    ...
                                    <div class="card-body text-center">
                                        <h6><a class="event_title" href="service.html" style="font-size: 22px;">Lavandería ecológica</a></h6>
                                        <div class="d-flex justify-content-around" style="width: 100%;">
                                            <a class="btn btn-primary" role="button" style="font-size: 18px;" href="create-service.html">Modificar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="card shadow">
        <div class="card-header py-3">
            <p class="text-center m-0 font-weight-bold" style="color: #267d24;font-size: 30px;">Servicios</p>
        </div>
        <div class="card-body text-left d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-start justify-content-sm-start justify-content-md-start justify-content-lg-start justify-content-xl-start">
            <div class="dropdown" style="width: 200px;">
            ...
            <div class="row">
                <div class="col-md-6 col-lg-4">
                    <div class="card border-0">
                        ...
                        <div class="card-body text-center">
                            <h6><a class="event_title" href="service.html" style="font-size: 22px;">Lavandería ecológica<br></a></h6>
                        </div>
                    </div>
                </div>
            </div>
