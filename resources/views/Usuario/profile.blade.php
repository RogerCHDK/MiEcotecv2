                ...
                <div class="col-lg-7">
                    <div class="p-5">
                        <form class="user" action="{{route('usuario.update', Auth::user()->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input class="form-control form-control-user" type="password" id="password" placeholder="Contraseña" name="password" value="{{$user->password}}" style="font-size: 18px;color: rgb(0,0,0);">
                                </div>
                                <div class="col-sm-6">
                                    <input class="form-control form-control-user" type="password" id="password" placeholder="Repetir contraseña" value="{{$user->password}}" name="password"  style="font-size: 18px;color: rgb(0,0,0);">
                                </div>
                            </div>
                            <label style="font-size: 18px;color: rgb(0,0,0);margin-right: 10px;width: 350px;">Coloca links de tus redes sociales</label>
                            <div class="form-group d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-sm-center align-items-sm-center justify-content-md-center align-items-md-center align-items-lg-center align-items-xl-center">
                                ...
                                <input class="form-control form-control-user" type="links" id="enlace_facebook" aria-describedby="emailHelp" placeholder="Perfil de Facebook" value="{{$user->enlace_facebook}}" name="enlace_facebook" style="font-size: 18px;color: rgb(0,0,0);">
                            </div>
                            <div class="form-group d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-sm-center align-items-sm-center justify-content-md-center align-items-md-center align-items-lg-center align-items-xl-center">
                                <i class="fa fa-instagram" style="font-size: 30px;margin-right: 10px;color: rgb(255,255,255);"></i>
                                <input class="form-control form-control-user" type="links" id="enlace_instagram" aria-describedby="emailHelp" placeholder="Perfil de Instagram" name="enlace_instagram" style="font-size: 18px;color: rgb(0,0,0);">
                            </div>
                            <div class="form-group d-flex d-sm-flex d-md-flex d-lg-flex d-xl-flex justify-content-center align-items-center justify-content-sm-center align-items-sm-center justify-content-md-center align-items-md-center align-items-lg-center align-items-xl-center">
                                <i class="fa fa-twitter-square" style="font-size: 30px;margin-right: 10px;color: #00aced;"></i>
                                <input class="form-control form-control-user" type="links" id="enlace_twitter" aria-describedby="emailHelp" placeholder="Perfil de Twitter" name="enlace_twitter" style="font-size: 18px;color: rgb(0,0,0);">
                            </div>
