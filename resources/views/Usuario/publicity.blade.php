                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-center justify-content-xl-center align-items-xl-center col-pub-2">
                                            ...
                                            <a class="btn btn-primary" role="button" href="create-product.html">Obtener publicidad</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-center justify-content-xl-center align-items-xl-center col-pub-2">
                                            ...
                                            <a class="btn btn-primary" role="button" href="create-service.html">Obtener publicidad</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col d-flex flex-column justify-content-center justify-content-sm-center justify-content-md-center justify-content-lg-center justify-content-xl-center align-items-xl-center col-pub-2">
                                            ...
                                            <a class="btn btn-primary" role="button" href="publicity-material.html">Obtener publicidad</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
