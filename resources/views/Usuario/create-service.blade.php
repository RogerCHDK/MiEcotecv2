                    ...
                    <div class="p-5">
                        <form class="user">
                            <div class="form-group row">
                                <input class="form-control form-control-user" type="text" placeholder="Nombre del establecimiento" name="nombreEvento" style="font-size: 18px;color: rgb(0,0,0);">
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0" style="margin-bottom: 10px!important">
                                    <input class="form-control form-control-user" type="text" placeholder="Estado" style="font-size: 18px;color: rgb(0,0,0);">
                                </div>
                                <div class="col-sm-6 mb-3 mb-sm-0" style="margin-bottom: 10px!important">
                                    <input class="form-control form-control-user" type="text" placeholder="Municipio" style="font-size: 18px;color: rgb(0,0,0);">
                                </div>
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input class="form-control form-control-user" type="text" placeholder="Colonia" style="font-size: 18px;color: rgb(0,0,0);">
                                </div>
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <input class="form-control form-control-user" type="text" placeholder="Calle" style="font-size: 18px;color: rgb(0,0,0);">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0" style="min-width: 100%;">
                                    <input class="form-control form-control-user" type="url" style="color: rgb(0,0,0);font-size: 18px;" placeholder="URL" name="url">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
