    ...
    <div class="card shadow">
        ...
        <div class="card-body">
            <div class="row d-md-flex d-lg-flex d-xl-flex justify-content-md-center justify-content-lg-center justify-content-xl-center mb-3">
                <div class="col-lg-7">
                    <div class="p-5"> 
                        <form class="user" action="{{route('comentarios.store')}}" method="POST"> 
                             @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <input class="form-control form-control-user" type="hidden"  name="id_usuario" id="id_usuario" value="{{$usuario->id}}">

                                <div class="col-sm-6 mb-3 mb-sm-0" style="min-width: 100%;">
                                    <textarea class="form-control form-control-user" placeholder="Sugerencia o comentario" name="comentario" id="comentario" style="font-size: 18px;color: rgb(0,0,0);"></textarea>
                                </div>
                            </div>
